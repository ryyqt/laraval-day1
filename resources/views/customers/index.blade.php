...
@section('meta_description', 'Manage all customers – create, edit and delete customers.')

@section('styles')
<style>
    /* ── Page-level styles for Customers Index ── */
    .cust-header {
        display: flex;
        align-items: center;
    ...
    .cust-phone svg { width: 14px; height: 14px; color: var(--text-muted); }
...
<div class="cust-header">
    <div class="cust-header-left">
        <h1>Customers</h1>
        <p>Manage your customer records – create, update, and remove entries.</p>
    </div>
    <a href="{{ route('customers.create') }}" class="btn btn-primary" id="btn-add-customer">
...
<div class="table-card">
    ...
    <div class="table-toolbar">
        ...
        <div class="search-wrap">
            ...
            <input type="text" id="search-input" placeholder="Filter customers…" aria-label="Search customers">
        </div>
    </div>
    ...
    @else
        ...
        <div style="overflow-x:auto;">
            <table id="customers-table" aria-label="Customers table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
                ...
                <tbody>
                    ...
                    <tr id="row-{{ $customer->id }}" data-search="{{ strtolower($customer->name) }} {{ strtolower($customer->email) }} {{ strtolower($customer->phone_number) }}">
                        ...
                        <td><span class="cust-email">{{ $customer->email }}</span></td>
                        <td>
                        ...
                        <td><span class="dt">{{ $customer->created_at->format('M d, Y') }}</span></td>
                        <td>
